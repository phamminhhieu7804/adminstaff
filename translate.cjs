...
function applyReplacements(filepath, reps) {
...
applyReplacements('C:/Users/phamm/.gemini/antigravity/scratch/admin-staff/src/tabs/ShiftsTab.jsx', shifts_replacements);
applyReplacements('C:/Users/phamm/.gemini/antigravity/scratch/admin-staff/src/tabs/StatusTab.jsx', status_replacements);
...
const viJsonPath = 'C:/Users/phamm/.gemini/antigravity/scratch/admin-staff/src/locales/vi/translation.json';
const enJsonPath = 'C:/Users/phamm/.gemini/antigravity/scratch/admin-staff/src/locales/en/translation.json';

const vi_json = loadJson(viJsonPath);
const en_json = loadJson(enJsonPath);

vi_json.shiftsTab = {};
en_json.shiftsTab = {};
for (const [k, v] of Object.entries(shifts_translations)) {
    vi_json.shiftsTab[k] = v[0];
    en_json.shiftsTab[k] = v[1];
}

vi_json.statusTab = {};
en_json.statusTab = {};
for (const [k, v] of Object.entries(status_translations)) {
    vi_json.statusTab[k] = v[0];
    en_json.statusTab[k] = v[1];
}

saveJson(viJsonPath, vi_json);
saveJson(enJsonPath, en_json);
